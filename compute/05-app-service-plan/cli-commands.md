...
The CLI requires an actual App Service SKU.
...
No Microsoft.Web resources were returned.
...
The Azure CLI installed the quota extension but reported that a specific:

--resource-name

was required.

This command therefore did not identify the quota directly.
...
1
Diagnosis
SKU available in East US       YES
Existing Microsoft.Web usage   NONE
Deployment command              VALID
Subscription quota              BLOCKED

The subscription needs a minimum Total VM quota of 1 in East US for this deployment.

No quota increase was requested for this lab.
...
The minimum new limit requested by Azure was:
